...
public class SecondExercise {
    ...
    void openMailHomePage() {
        ...
        WebElement test = driver.findElement(By.xpath("//*[@href = '/1/?']"));
        test.click(); // открыть папку Test
        //WebElement correspondentTest = driver.findElement(By.xpath("//*[@title = 'llct__correspondent llct__correspondent_new']")); yt yf[jlbn
        WebElement subjectTest = driver.findElement(By.xpath("//*[@class = 'll-sj__normal']"));
        WebElement bodyTest = driver.findElement(By.xpath("//*[@class = 'llct__snippet']"));



        //Assertions.assertThat(test.getText()).isEqualTo("Test"); ?
        //Assertions.assertThat(correspondentTest.getText()).isEqualTo("Test Testovich"); не ищет
        //Assertions.assertThat(subjectTest.getText()).isEqualTo("Test");
        Assertions.assertThat(bodyTest.getText()).isEqualTo("test body -- Test Testovich Отправлено из Почты Mail.ru");
